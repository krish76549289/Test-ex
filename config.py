...
BOT_TOKEN = getenv("BOT_TOKEN", "7376874106:AAG6ixunBF8aF5HBR87kWsecj3Q8GJ5P0RQ")
...
CHANNEL_ID = int(getenv("CHANNEL_ID", "-1002649968638"))
PREMIUM_LOGS = int(getenv("PREMIUM_LOGS", "-1002668283003")) "6126688051"))
